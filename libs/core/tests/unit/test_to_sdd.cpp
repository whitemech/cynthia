...
TEST_CASE("Test SDD of tt", "[core][SDD]") {
  ...
  auto context = Context(tt, partition);
...
TEST_CASE("Test SDD of ff", "[core][SDD]") {
  ...
  auto context = Context(ff, partition);
...
TEST_CASE("Test SDD of true", "[core][SDD]") {
  ...
  auto context = Context(true_, partition);
...
TEST_CASE("Test SDD of false", "[core][SDD]") {
  ...
  auto context = Context(false_, partition);
...
TEST_CASE("Test SDD of a", "[core][SDD]") {
  ...
  auto context = Context(a, partition);
